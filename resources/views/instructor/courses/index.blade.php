        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h4 class="mt-2">{{ $courses->sum('purchases_count') }}</h4>
                        ...
                        <tbody>
                            @foreach($courses as $course)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-success">{{ $course->purchases_count ?? 0 }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('instructor.courses.lessons', $course) }}" 
                                               class="btn btn-sm btn-outline-info" title="إدارة الدروس">
                                                <i class="bi bi-play-circle"></i>
                                            </a>
                                            <a href="{{ route('instructor.courses.quizzes', $course) }}" 

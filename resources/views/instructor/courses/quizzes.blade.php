...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('instructor.quizzes.create', $course) }}" class="btn btn-primary">
        ...
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('instructor.quizzes.edit', [$course, $quiz]) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('instructor.quizzes.create', $course) }}" class="btn btn-primary btn-lg">

...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('instructor.courses.index') }}" class="btn btn-outline-secondary me-2">
            ...
            <a href="{{ route('instructor.courses.lessons', $course) }}" class="btn btn-info">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('instructor.courses.lessons', $course) }}" class="btn btn-primary">

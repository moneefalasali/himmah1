...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('instructor.dashboard') }}" class="btn btn-outline-secondary me-2">
                <i class="bi bi-arrow-right me-2"></i>العودة للوحة التحكم
            </a>
            <a href="{{ route('instructor.students') }}" class="btn btn-info">
                <i class="bi bi-people me-2"></i>قائمة الطلاب
            </a>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach($courseEarnings as $earning)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('instructor.courses.show', $earning->course) }}" 

    ...
    <div class="row g-4">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('instructor.quizzes.update', [$course, $quiz]) }}" method="POST">
                        @csrf
                        @method('PUT')
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <strong>عدد الأسئلة:</strong> {{ $quiz->questions->count() }}
                    </div>
                    
                    <div class="mb-3">
                        <strong>إجمالي النقاط:</strong> {{ $quiz->total_points }}
                    </div>
                    
                    <div class="mb-3">
                        <strong>عدد المحاولات:</strong> {{ $quiz->attempts->count() }}
                    </div>

    ...
    <div class="container mx-auto px-6 -mt-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center group">
                ...
                <a href="{{ env('PLATFORM_WHATSAPP') ? env('PLATFORM_WHATSAPP') : 'mailto:' . 'hemmah.platform.app@gmail.com' }}" target="_blank" rel="noopener" class="inline-block w-full bg-gray-50 text-blue-600 px-8 py-4 rounded-2xl font-bold hover:bg-blue-600 hover:text-white transition-all">تواصل الآن</a>
            </div>
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center group">
                ...
                <a href="{{ env('PLATFORM_WHATSAPP') ? env('PLATFORM_WHATSAPP') : 'mailto:' . 'hemmah.platform.app@gmail.com' }}" target="_blank" rel="noopener" class="inline-block w-full bg-gray-50 text-green-600 px-8 py-4 rounded-2xl font-bold hover:bg-green-600 hover:text-white transition-all">اطلب استشارة</a>
            </div>
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center group">
                ...
                <a href="{{ env('PLATFORM_WHATSAPP') ? env('PLATFORM_WHATSAPP') : 'mailto:' . 'hemmah.platform.app@gmail.com' }}" target="_blank" rel="noopener" class="inline-block w-full bg-gray-50 text-purple-600 px-8 py-4 rounded-2xl font-bold hover:bg-purple-600 hover:text-white transition-all">تواصل معنا</a>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[3rem] p-12 md:p-20 text-white flex flex-col lg:flex-row items-center justify-between shadow-2xl shadow-blue-200 relative overflow-hidden">
            ...
            <a href="{{ env('PLATFORM_WHATSAPP') ? env('PLATFORM_WHATSAPP') : 'mailto:' . 'hemmah.platform.app@gmail.com' }}" target="_blank" rel="noopener" class="relative z-10 bg-white text-blue-600 px-12 py-5 rounded-[2rem] font-black text-xl hover:bg-blue-50 transition-all shadow-xl hover:shadow-white/20 transform active:scale-95">

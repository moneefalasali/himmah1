...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('teacher.quizzes.index', ['course' => $course->id]) }}" class="btn btn-outline-warning">
...
@push('scripts')
    ...
    <script>
        ...
        function editSection(id, title) {
            ...
            document.getElementById('editSectionForm').action = `/teacher/courses/{{ $course->id }}/sections/${id}`;

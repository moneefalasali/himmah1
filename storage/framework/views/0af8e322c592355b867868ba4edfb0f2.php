        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header text-center">
                    ...
                    <small class="text-muted">أو <a href="<?php echo e(route('register')); ?>">إنشاء حساب جديد</a></small>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <div class="d-grid">
                            <a href="<?php echo e(route('login.google')); ?>" class="btn btn-light border">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\himm23\resources\views/auth/login.blade.php ENDPATH**/ ?>
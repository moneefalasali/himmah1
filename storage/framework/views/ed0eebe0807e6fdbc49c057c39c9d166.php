<?php $__env->startSection('title', 'منصة همة التعليمية - الرئيسية'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-light btn-lg">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('register.teacher')); ?>" class="btn btn-outline-light btn-lg">
        ...
        <div class="row g-4">
            <div class="col-md-3 col-sm-6">
                <div class="stats-card p-4 text-center">
                    <h3 class="fw-bold mb-2"><?php echo e(\App\Models\Course::count()); ?>+</h3>
                    <p class="mb-0">دورة تدريبية</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stats-card p-4 text-center">
                    <h3 class="fw-bold mb-2"><?php echo e(\App\Models\User::where('role', 'user')->count()); ?>+</h3>
                    <p class="mb-0">طالب مسجل</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stats-card p-4 text-center">
                    <h3 class="fw-bold mb-2"><?php echo e(\App\Models\Purchase::where('payment_status', 'completed')->count()); ?>+</h3>
                    <p class="mb-0">عملية شراء</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stats-card p-4 text-center">
                    <h3 class="fw-bold mb-2"><?php echo e(\App\Models\ServiceRequest::where('status', 'completed')->count()); ?>+</h3>
    ...
    <div class="container">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="rating-stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <?php if($i <= $course->averageRating()): ?>
                                            <i class="fas fa-star"></i>
                                        <?php else: ?>
                                            <i class="far fa-star"></i>
                                        <?php endif; ?>
                                    <?php endfor; ?>
                                    <small class="text-muted ms-1">(<?php echo e($course->reviews()->count()); ?>)</small>
                                </div>
                                <span class="badge bg-primary"><?php echo e($course->studentsCount()); ?> طالب</span>
                            </div>
                            
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="text-primary mb-0"><?php echo e($course->formatted_price); ?></h5>
                                <a href="<?php echo e(route('courses.show', $course)); ?>" class="btn btn-primary">
                                    عرض التفاصيل
                                </a>
                            </div>
                        </div>
        ...
        <?php if($popularCourses->count() > 0): ?>
            <div class="text-center mt-4">
                <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-outline-primary btn-lg">
                    عرض جميع الدورات
    ...
    <div class="container text-center">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                ...
                <a href="<?php echo e(route('register.teacher')); ?>" class="btn btn-light btn-lg">
                    <i class="fas fa-chalkboard-teacher me-2"></i>
                    إنشاء حساب معلم
                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\himm23\resources\views/welcome.blade.php ENDPATH**/ ?>